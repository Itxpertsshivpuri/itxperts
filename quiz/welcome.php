...
<head>
    ...
    <script src="js/bootstrap.min.js"  type="text/javascript"></script>
     <script>(function(w, d) { w.CollectId = "60b6ed0b7948c2395d09a895"; var h = d.head || d.getElementsByTagName("head")[0]; var s = d.createElement("script"); s.setAttribute("type", "text/javascript"); s.async=true; s.setAttribute("src", "https://collectcdn.com/launcher.js"); h.appendChild(s); })(window, document);</script>
...
<body>
    <nav class="navbar navbar-default title1">
        ...
        <a class="navbar-brand" href="#"><b>Itxperts - Online Quiz System</b></a>
        </div>
        ...
        <ul class="nav navbar-nav navbar-right">
            <li <?php echo''; ?> > <a href="#"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;Welcome-<b><?php echo $_SESSION['name'] ?></b></a></li>
    ...
    <center>
           Follow us<br><a href="https://www.facebook.com/itxpertsshivpuri"><span class="fa fa-facebook" aria-hidden="true"></span></a>&nbsp
            <a href="https://www.instagram.com/itxpertsshivpuri"><span class="fa fa-instagram" aria-hidden="true"></span></a>&nbsp
            <a href="https://twitter.com/itxpertsshivpur"><span class="fa fa-twitter" aria-hidden="true"></span></a>
        ...
        <div class="row">
            <div class="col-md-12">
                <?php if(@$_GET['q']==1) 
                {
                    ...
                    echo  '<div class="col-md-12" style="background-color:white;padding:0px;"> <table class="table table-striped table-dark">
                ...
                <?php
                    if(@$_GET['q']== 2) 
                    {
                        ...
                        echo  '<div class="col-md-12" style="background-color:white;padding:0px;">
                    ...
                    if(@$_GET['q']== 3) 
                    {
                        ...
                        echo  '<div class="col-md-12" style="background-color:white;padding:0px;"><div class="table-responsive">
                        <table class="table table-striped title1" >
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <marquee> We are adding more quiz based on different topics of Python & MYSQL. Please check this page frequently for upcoming quizzes. </marquee>
            
                <button type="button" class="btn btn-primary">
                Total Users <span class="badge badge-light">
                <?php  
                    $c=0;
                   $r=mysqli_query($con,"SELECT * FROM user " )or die('Error157');
                ...
                Total Quiz <span class="badge badge-warning">
                <?php  
                    $k=0;
                   $r=mysqli_query($con,"SELECT * FROM quiz " )or die('Error157');
                    while($row=mysqli_fetch_array($r) )
                    {
                            $k=$k+1;
                    }
    ...
    <br>
         ...
         <?php
         $sql ="SELECT u.name,r.score FROM user u,rank r where u.email=r.email";
       ...
       <div class="container">
        <div class="row">
            <div class="col-md-12" style="background-color:white;text-align:center">
                ...
                <center><font color="black">Powered by -</font> <b><a style="color:blue;" href="https://www.itxperts.co.in/">Itxperts</a></b></center>
