        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li <?php if(@$_GET['q']==6) echo'class="active"'; ?>><a href="dashboard.php?q=6">Students</a></li>
            ...
            <div class="col-md-12" style="background-color:white;">
                ...
                <?php 
                    if(@$_GET['q']==6) 
                    {
                       ...
                       $vi = mysqli_query($con,"select class,subject, count(*)as total from students group by class")or die('Error');
                        ...
                        while($row = mysqli_fetch_array($vi))  
                        {  
                            echo "<tr>";  
                        ...
                        echo  '<table border=1>
                        <tr><td><center><b>SNO</b></center></td><td><center><b>Name</b></center></td><td><center><b>DOB</b></center></td><td><center><b>Gender</b></center></td><td><center><b>Class</b></center></td><td><center><b>School</b></center></td><td><center><b>Subject</b></center></td> <td><center><b>Email ID</b></center></td><td><center><b>Mobile</b></center></td>  </tr>';
                        $c=1;
                        while($row = mysqli_fetch_array($result)) 
                        {
                            $name = $row['name'];
                            ...
                            $email = $row['email'];
                            $mobile = $row['mobile'];
                           echo '<tr><td>'.$c++.'</td><td>'.$name.'</td><td>'.$dob.'</td>
...
<td><center><a title="Delete User" href="#"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></center></td></tr>';
         ...
         <?php       
                ...
                echo"<h2>Website Course Registreation</h2>";
                $resul = mysqli_query($con,"SELECT * FROM website") or die('Error');
                        echo  '<table border=1>
                        <tr><td><center><b>SNO</b></center></td><td><center><b>Name</b></center></td><td><center><b>DOB</b></center></td> <td><center><b>Email ID</b></center></td><td><center><b>Mobile</b></center></td>  </tr>';
                        $c=1;
